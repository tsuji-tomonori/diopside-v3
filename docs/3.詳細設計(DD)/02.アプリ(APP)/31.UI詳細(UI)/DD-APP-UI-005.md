...
- [[DD-APP-UI-003|UI-U02]] 内で利用する入力部品として、条件確定イベントは [[DD-APP-UI-012|SearchConditionPanel]] に委譲する。
...
## 変更履歴
- 2026-02-14: [[DD-APP-UI-003|UI-U02]] および [[DD-APP-UI-012|SearchConditionPanel]] との責務境界リンクを追加
