...
- 2026-02-13: docs公開部分失敗時のロールバック状態遷移と `publish_runs/publish_steps` 拡張状態を追加 [[BD-SYS-ADR-027]]
- 2026-02-11: 公開ジョブの実行登録先を「同一Backend API内ジョブ実行モジュール」へ明確化 [[BD-SYS-ADR-021]]
