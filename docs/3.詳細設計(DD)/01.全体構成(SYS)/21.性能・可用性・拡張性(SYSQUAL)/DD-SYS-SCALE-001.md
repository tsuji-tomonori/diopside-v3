...
- 拡張は「配信」「検索評価」「[[RQ-GL-002|収集実行]]」の3系統に分離し、ボトルネック単位で段階的に適用する。
...
## 変更履歴
- 2026-02-11: [[BD-SYS-QUAL-001|品質特性]]/[[BD-SYS-ARCH-004|主要データフロー]]との追跡性補強のため `BD-SYS-QUAL-001` `BD-SYS-ARCH-004` 参照を追加
