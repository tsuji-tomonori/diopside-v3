...
## 目的
- [[RQ-PS-001-01]] の性能閾値を、同一条件で継続計測し判定可能にする。
...
| 指標ID | 測定区間 | 閾値 | 根拠 |
| --- | --- | --- | --- |
| PERF-LCP | 初回表示開始 -> 主表示安定 | 2.5秒以下 | [[RQ-PS-001-01]] |
| PERF-SEARCH | 検索操作確定 -> 再描画完了 | 1.5秒以下 | [[RQ-PS-001-01]] |
| PERF-LOAD | `archive_index.pN` 読込開始 -> 結果表示 | 2.0秒以下 | [[RQ-PS-001-01]] |
| PERF-SORT | 並び替え操作確定 -> 並び替え完了 | 1.0秒以下 | [[RQ-PS-001-01]] |
...
## 変更履歴
- 2026-02-23: 品質特性参照を APP/INF 分割正本へ更新 [[BD-SYS-ADR-040]]
- 2026-02-11: 品質特性との追跡性補強のため参照を追加
