...
## 目的
- [[DD-UI-009|UI-A04]] からの[[RQ-GL-005|タグ辞書]]更新と動画への手動タグ付けを、DB正本へ安全に反映する。
- [[DD-UI-009|UI-A04]] で外部LLM（ChatGPT）向け入力生成と結果JSON取込を実行し、検証成功時のみタグ反映できるようにする。
...
- [[DD-UI-009|UI-A04]] からの手動タグ付けが理由付きで記録されること。
...
## 変更履歴
- 2026-02-14: 画面参照を [[DD-UI-009|UI-A04]] へリンク化
