...
| リソース | DR設定値 | 目標値 | 根拠 |
|---|---|---|---|
| 配信経路（CloudFront/S3） | 直前安定版artifactで切戻し | RTO 30分以内 | 公開導線を最短で復旧し、[[RQ-SH-002|利用者]]影響を抑えるため。 |
...
|---|---|---|---|
| サービス断 | 監視確認、影響経路特定、告知開始 | 直前安定版へ切戻し、`/api/v1/ops/diagnostics/health`確認 | 主要経路200応答、5xx率<1% |
