...
## 詳細仕様
- 詳細モーダル（[[DD-UI-004|UI-U03]]）は動画詳細情報と補助表示（波形/[[RQ-GL-017|ワードクラウド]]）を1箇所で提示する。
- モーダル表示中も背景一覧状態を保持し、閉じた際に復帰する。
- 部品実装責務は [[DD-UI-014|ArchiveDetailModal]], [[DD-UI-015|HighlightWavePanel]], [[DD-UI-016|WordCloudPanel]] を参照する。
...
## 変更履歴
- 2026-02-14: `UI-U03` を明記し、詳細モーダル関連コンポーネント文書（`DD-UI-014`〜`DD-UI-016`）への参照を追加
