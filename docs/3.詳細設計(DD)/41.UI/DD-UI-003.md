...
## 詳細仕様
- フィルタドロワー（[[DD-UI-003|UI-U02]]）は[[RQ-GL-014|検索条件]]入力を集約し、確定操作まで一覧再評価を遅延させる。
- 端末幅390pxでは全画面ドロワー、768px以上ではサイドパネルとして表示する。
- 部品実装責務は [[DD-UI-012|SearchConditionPanel]] で定義する。
...
## 変更履歴
- 2026-02-14: [[DD-UI-012|SearchConditionPanel]] への参照を追加し、画面ID `UI-U02` を明記
