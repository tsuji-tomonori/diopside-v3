...
## テスト目的
- [[DD-API-002]]〜[[DD-API-015]] の契約が、実行基盤・配信データ・Web表示・運用導線で一貫して成立することを検証する。
...
- [[IT-CASE-009]]: [[DD-API-011]]（収集結果明細API）
- [[IT-CASE-010]]: [[DD-API-012]]（配信前後再確認API）
- [[IT-CASE-011]]: [[DD-API-013]], [[DD-API-014]], [[DD-API-015]]（タグ管理/公開実行/公開状態）
- [[IT-CASE-012]]: [[DD-API-008]], [[DD-API-009]]（障害復旧・[[RQ-GL-011|再収集]]導線）
- [[IT-CASE-013]]: [[DD-API-013]]（タグ管理と公開反映整合）
...
## 変更履歴
- 2026-02-13: API対象を [[DD-API-015]] まで拡張し、[[IT-CASE-009]]〜[[IT-CASE-013]] と受入接続条件を追加
