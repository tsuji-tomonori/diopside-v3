...
## テスト目的
- [[RQ-GL-005|タグ辞書]]契約、タグ解決、廃止タグの後方互換動作を単体で検証する。

## 前提
- [[RQ-GL-005|タグ辞書]]読み込み処理とUI変換処理を分離して検証可能である。
...
## 期待結果
- [[RQ-GL-005|タグ辞書]]からUIカテゴリが正しく生成される。
...
- 2026-02-10: 新規作成
- 2026-02-10: DD-APP-API-005対応のAPI単位ケースへ細分化
