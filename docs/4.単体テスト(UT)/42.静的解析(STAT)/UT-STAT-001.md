...
| [[UT-STAT-003]] | DOC | auto_link_glossary.py --check | changed docs markdown files | docs_root=docs, mode=check, glossary_source=docs/1.要求(RQ)/21.用語(GL)/RQ-GL-*.md | `python3 .opencode/skills/obsidian-doc-new/scripts/auto_link_glossary.py --docs-root docs --check <targets...>` | exit_code == 0 and changed == 0 |
