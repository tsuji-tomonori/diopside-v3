...
- 主要用途: 利用者向け配信、管理画面運用、公開手順/障害手順の実運用。
...
- ネットワーク境界と環境昇格ルールの正本は [[BD-INF-002]] / [[BD-INF-003]] とする。

## 変更履歴
- 2026-02-13: INF文書参照（環境分割/ネットワーク境界）を追加 [[BD-ADR-028]]
- 2026-02-11: 本番環境の定義（経路/依存/品質制約/検証方針）を具体化 [[BD-ADR-018]]
- 2026-02-10: 新規作成
