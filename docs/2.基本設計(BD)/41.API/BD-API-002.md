...
- HTTPメソッド/ステータス/ページング/エラー表現/互換性は [[BD-API-005]] を共通規約として適用する。
- 実装時の入力検証・例外集約（Hono + Zod）は [[BD-API-005]] と [[BD-ADR-025]] の規約に従う。
...
- 2026-02-11: LLM支援タグ運用向けにタグ提案入力契約/タグ提案取込契約を追加 [[BD-ADR-021]]
- 2026-02-11: 管理画面向け更新契約（タグ更新/配信反映）を追加し参照系と責務分離 [[BD-ADR-021]]
- 2026-02-11: 取得3モード、実行契約、更新種別/取得元区分の出力契約を追加 [[BD-ADR-021]]
- 2026-02-10: 新規作成 [[BD-ADR-021]]
