...
## 影響
- ビルド設計: [[BD-BUILD-001]] に単位別方針、成果物、ゲート、受入条件を追加する。
- デプロイ設計: [[BD-DEP-003]] / [[BD-DEP-004]] の経路分離とビルド責務の対応を明確化する。
- API設計: [[BD-API-004]] の版境界をバックエンド単位のビルド受入条件へ反映する。
