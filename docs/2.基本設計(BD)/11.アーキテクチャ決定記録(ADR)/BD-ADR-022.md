...
## 影響
- 監視設計: [[BD-MON-001]] / [[BD-MON-002]] で30日検索可能期間を前提に運用手順を維持する。
- ログ詳細: [[DD-LOG-001]] でイベント語彙、必須項目、保持削除ルールを具体化する。
- セキュリティ詳細: [[DD-SEC-001]] で監査ログ保持期間を30日へ統一する。
