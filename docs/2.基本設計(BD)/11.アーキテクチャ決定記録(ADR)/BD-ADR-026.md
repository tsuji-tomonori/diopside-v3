...
## 決定事項
- 基本設計のテスト戦略は、単体テスト（UT）/結合テスト（IT）/受入テスト（AT）の三層で運用する。
...
## 影響
- [[BD-TST-001]] を三層戦略の親文書として再構成し、責務境界・接続条件・品質ゲートを明文化する。
- [[UT-PLAN-001]] / [[IT-PLAN-001]] / [[AT-PLAN-001]] を、層間接続前提で参照する運用に統一する。
- 影響確認レポート（`reports/impact_check_2026-02-11.md`）に、テスト戦略変更の整合判定を追記する。
...
## 変更履歴
- 2026-02-11: 新規作成（UT/IT/AT三層品質ゲートの採用決定） [[BD-ADR-026]]
