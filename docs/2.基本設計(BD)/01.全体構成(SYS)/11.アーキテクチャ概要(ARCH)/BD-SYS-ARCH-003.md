...
## 論理構成補足
- 論理構成の正本は [[BD-SYS-ARCH-002]] とし、本書のクラウド配置は `フロントエンド` `バックエンド` `インフラ` `データベース` の4区分に対応づけて解釈する。
...
## 変更履歴
- 2026-02-15: 論理構成正本（[[BD-SYS-ARCH-002]]）との対応を追記し、4区分とバックエンド内処理形態分離を配置視点で明確化 [[BD-SYS-ADR-033]]
