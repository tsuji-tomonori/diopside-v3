...
## 変更履歴
- 2026-02-11: 新規作成（配信/運用/監視の3境界アーキテクチャ） [[BD-SYS-ADR-014]]
- 2026-02-11: 監視文脈のADR参照を整理（経路境界/監視SLO/CloudWatch保持） [[BD-SYS-ADR-022]]
- 2026-02-13: Mermaid経路ノードを引用ラベルへ修正（描画エラー回避） [[BD-SYS-ADR-014]]
