...
## 影響
- デプロイ設計: [[BD-INF-DEP-004]] にpath予約、cache policy、invalidation範囲を反映する。
- API設計: [[BD-APP-API-004]] にOpenAPI公開経路と版対応を反映する。
- 詳細設計: [[DD-INF-DEP-002]] でbehavior詳細、[[DD-APP-API-010]] で `/api/v1/*` 命名を具体化する。
