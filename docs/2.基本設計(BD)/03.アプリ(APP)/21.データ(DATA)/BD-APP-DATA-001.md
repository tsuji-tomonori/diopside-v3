...
- [[RQ-PC-003]] と [[RQ-PRC-001-01]] に基づき、コメント本文/チャット本文/字幕本文の恒久保存は行わない。
...
## 変更履歴
- 2026-02-13: [[RQ-GL-005|タグ辞書]]のDB正本と配信JSONの同期フロー、LLM取込後の反映後処理を追加 [[BD-SYS-ADR-027]]
- 2026-02-11: LLM出力JSONの取込検証層と `tag_master/archive_index` 同時再生成条件を追加 [[BD-SYS-ADR-021]]
- 2026-02-11: 収集明細/再確認runを追加し、品質属性とrun状態語彙を具体化 [[BD-SYS-ADR-021]]
- 2026-02-11: [[RQ-GL-018|配信反映実行]]中心の配信生成属性と公開整合ゲートを追加 [[BD-SYS-ADR-021]]
- 2026-02-11: DB正本層/配信生成層/配信公開層へ再整理し、再生成・公開切替ルールを追加 [[BD-SYS-ADR-021]]
- 2026-02-11: データ層構成、追跡属性、品質ゲートを追加し収集モード分離へ対応 [[BD-SYS-ADR-001]]
