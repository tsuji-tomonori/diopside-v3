...
- API
- OpenAPI
openapi_operation_id: createTag
openapi_method: POST
openapi_path: /api/v1/admin/tags
---
...
| --- | --- | --- | --- | --- | --- |
| tag_name | yes | string | - | minLength: 1 | タグ名称。 |
| tag_type_id | yes | string | - | minLength: 1 | [[RQ-GL-013\|タグ種別]]の識別子。 |
| synonyms | no | array<string> | [] | - | 同義語一覧。 |
| is_active | no | boolean | true | - | 有効状態かどうか。 |

## 戻り値
| ステータス | メディアタイプ | 型 | 制約 | 説明 |
| --- | --- | --- | --- | --- |
| 201 | application/json | object | - | Created |
