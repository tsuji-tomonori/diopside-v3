...
## 入力再利用とヘルプ導線
- [[RQ-UX-013]]: フィルタドロワー（[[DD-APP-UI-003|UI-U02]]）を再表示した場合でも、直前に確定した[[RQ-GL-014|検索条件]]を初期値として復元する。
...
- 2026-02-11: [[RQ-FR-021]] 対応として詳細モーダルの[[RQ-GL-017|ワードクラウド]]表示仕様とフォールバック挙動を追加 [[BD-SYS-ADR-009]]
