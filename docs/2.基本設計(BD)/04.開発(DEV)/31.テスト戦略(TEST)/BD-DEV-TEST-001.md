...
- 各層は「責務境界」と「判定粒度」を分離し、上位層ほど[[RQ-SH-002|利用者]]価値と運用可否の判定へ寄せる。
...
- AT完了条件: Must要求の[[AT-GO-001|リリース判定]]が成立し、[[AT-GO-001]] のGo/No-Go入力が記録済みであること。
...
| 非機能（可用性/性能/可観測性） | [[RQ-AV-001-01]], [[RQ-PS-001-01]], [[RQ-OBY-001-01]] | IT | AT |
