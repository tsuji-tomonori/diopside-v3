...
- 受入基準:
  ...
  - DB正本更新後、配信用 [[RQ-GL-008|tag_master]] の再生成を起動できる。
  - 公開切替後の [[RQ-GL-008|tag_master]] は更新内容を反映し、公開前版との差分を追跡できる。
...
- 公開切替後に利用者向け [[RQ-GL-008|tag_master]] が更新内容を返すこと。
...
- 2026-02-11: DB正本更新と配信用[[RQ-GL-008|tag_master]]再生成の受入条件を追加 [[RQ-RDR-034]]
