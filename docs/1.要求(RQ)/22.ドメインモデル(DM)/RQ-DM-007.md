...
- 条件項目の意味は[[RQ-SH-002|利用者]]UIと説明文で一致していること。
...
## 関連
- [[RQ-DM-003|タグエンティティ]]（[[RQ-DM-003]]）および[[RQ-GL-013|タグ種別]]エンティティ（[[RQ-DM-004]]）と関連し、絞り込み条件を構成する。
- [[RQ-DM-001|動画エンティティ]]（[[RQ-DM-001]]）と関連し、抽出対象を定義する。
...
- 2026-02-10: [[RQ-GL-014|検索条件]] を正本参照として追加 [[RQ-RDR-010]]
- 2026-02-10: 関連節の文書ID参照をObsidianリンクへ統一 [[RQ-RDR-010]]
- 2026-02-10: ドメイン目線へ再整理（要素・制約・関連を日本語で再記述、実装寄り項目を削除） [[RQ-RDR-010]]
- 2026-02-10: モデル定義を具体化（検索属性、評価属性、再現性条件を追加） [[RQ-RDR-010]]
