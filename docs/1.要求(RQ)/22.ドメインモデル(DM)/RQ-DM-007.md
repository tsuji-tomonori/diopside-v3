...
## 集約境界/集約ルート
- 集約名: [[RQ-GL-006|アーカイブ索引]]集約
- 集約ルート: [[RQ-GL-006|アーカイブ索引]]（`archive_index_catalog`）
- 境界に含む要素: ページング済み索引（[[RQ-GL-009|archive_index]]）、[[RQ-GL-014|検索条件]]、並び順、評価時点情報
...
## 変更履歴
- 2026-02-14: 用語参照を「[[RQ-GL-002|収集実行]]」へ統一し、[[RQ-GL-006|アーカイブ索引]]集約の集約境界/集約ルートを明記 [[RQ-RDR-040]]
