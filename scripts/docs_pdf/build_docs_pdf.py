...
def _rewrite_heading_line(line: str) -> str:
...
"""
    ...
    for i, note in enumerate(notes):
        ...
        # Keep TOC at note title level only.
...
def main() -> None:
    ...
    ap.add_argument("--toc-depth", type=int, default=1, help="TOC depth")
