---
name: doc-dd-cicd-inf
description: DD-CICD-INF（インフラ詳細）文書を作成・更新するときに、CI/CDとインフラ運用の実装レベル設計をdiopside規約準拠で整理する
metadata:
  short-description: DD-CICD-INF 文書の更新ガイド
---
...
## このスキルを使う条件
- `docs/3.詳細設計(DD)/13.インフラ詳細(INF)/DD-CICD-INF-*.md` を新規作成・改訂するとき。
- CI/CD とインフラ運用（構成反映、検証、ロールバック）の詳細手順・制約を更新するとき。
