---
name: doc-dd-obs
description: DD-OBS（インフラ詳細）文書を作成・更新するときに、監視と可観測性の実装レベル設計をdiopside規約準拠で整理する
metadata:
  short-description: DD-OBS 文書の更新ガイド
---
...
## このスキルを使う条件
- `docs/3.詳細設計(DD)/13.インフラ詳細(INF)/DD-OBS-*.md` を新規作成・改訂するとき。
- メトリクス/ログ/アラートの監視詳細設計を更新するとき。
