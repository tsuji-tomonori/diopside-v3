---
name: doc-dd-iam
description: DD-IAM（インフラ詳細）文書を作成・更新するときに、認可境界と最小権限の実装レベル設計をdiopside規約準拠で整理する
metadata:
  short-description: DD-IAM 文書の更新ガイド
---
...
## このスキルを使う条件
- `docs/3.詳細設計(DD)/13.インフラ詳細(INF)/DD-IAM-*.md` を新規作成・改訂するとき。
- 認可境界・ロール/ポリシー・最小権限の具体設計を更新するとき。
