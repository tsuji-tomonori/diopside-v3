---
name: doc-dd-dr
description: DD-DR（インフラ詳細）文書を作成・更新するときに、障害復旧設計の実装レベル仕様をdiopside規約準拠で整理する
metadata:
  short-description: DD-DR 文書の更新ガイド
---
...
## このスキルを使う条件
- `docs/3.詳細設計(DD)/13.インフラ詳細(INF)/DD-DR-*.md` を新規作成・改訂するとき。
- 障害復旧方針（RTO/RPO、切替判断、復旧手順）の詳細設計を更新するとき。
