---
name: doc-dd-net
description: DD-NET（インフラ詳細）文書を作成・更新するときに、ネットワーク経路と通信制御の実装レベル設計をdiopside規約準拠で整理する
metadata:
  short-description: DD-NET 文書の更新ガイド
---
...
## このスキルを使う条件
- `docs/3.詳細設計(DD)/13.インフラ詳細(INF)/DD-NET-*.md` を新規作成・改訂するとき。
- ネットワーク経路、TLS、到達制御、セグメント分離の具体設計を更新するとき。
